...
final class ExportEngine: ObservableObject {
    ...
    private func buildAndExport(
        ...
        let pass1URL = needsSecondPass
            ? FileManager.default.temporaryDirectory.appendingPathComponent("filmers_pass1_\(Int(Date().timeIntervalSince1970)).mp4")
            : FileManager.default.temporaryDirectory.appendingPathComponent("filmers_export_\(Int(Date().timeIntervalSince1970)).mp4")
        ...
        let finalURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("filmers_export_\(Int(Date().timeIntervalSince1970)).mp4")
    ...
    private static func loadWatermarkCIImage(renderSize: CGSize) -> CIImage? {
        ...
        let logo: UIImage? = UIImage(named: "WatermarkLogo")
            ?? Bundle.main.url(forResource: "Filmers_logo_white", withExtension: "png")
